...
\usepackage[b5paper, textwidth={34em}, vmargin={1.5cm}, nohead, includeheadfoot]{geometry}
...
\usepackage[
  ...
  Verb = false]
{xeCJK} 
\setCJKmainfont[Scale=0.98, BoldFont={Noto Serif CJK JP Bold}]{Noto Serif CJK JP Medium}
